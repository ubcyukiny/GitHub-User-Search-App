  ...
  return (
    <div className="flex w-full bg-neutral-100 px-4 py-8">
      <div className="flex w-full flex-col gap-8">
        ...
        <div className="flex flex-row items-center justify-between gap-2 rounded-2xl bg-white px-3 py-2 shadow-xl">
          ...
          <button className="textPreset5 rounded-[10px] bg-blue-500 px-5 py-3 text-white">
            Search
          </button>
        </div>
